...
2. Загрузка и настройка образа виртуальной машины.
    ...
    Образ виртуальной машины доступен по ссылке:  https://drive.google.com/file/d/1PHRCogQvtloplJjNcyy1kmmGqcYK4KQo/view?usp=sharing (2.5 Гб)
...
#### 2.3
- тулчейн для rpi теперь по-настоящему рабочий и позволяет линковаться с sysrootom самой малинки